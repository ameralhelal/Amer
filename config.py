...
DEFAULTS = {
    ...
    # فاصل سعر بين شراءين لنفس الرمز (%): سالب = يلزم هبوطاً من سعر آخر شراء؛ موجب = يلزم صعوداً؛ 0 = معطّل (يُقيَّد بين −10 و+10 في الواجهة)
    "bot_same_symbol_buy_min_price_move_pct": 0.0,
